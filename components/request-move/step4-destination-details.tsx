...
export default function Step4DestinationDetails({ data, location, onNext, onBack }: Step4Props) {
  const t = useTranslations('orderMove.step4');
  ...
  const handleNext = () => {
    ...
    onNext({ destinationDetails: formData });
  };
