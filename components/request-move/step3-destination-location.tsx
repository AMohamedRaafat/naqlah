...
export default function Step3DestinationLocation({ data, onNext, onBack }: Step3Props) {
  const t = useTranslations('orderMove.step3');
  ...
  const handleNext = () => {
    ...
    onNext({ destinationLocation: location });
  };
    ...
    <div className="w-full">
      ...
      <div className="bg-white rounded-2xl p-6 mb-6 shadow-sm">
        <h2 className="text-xl font-bold text-gray-900 text-center mb-2">
          {t('title') || 'ماهو الموقع المراد النقل إليه'}
        </h2>
